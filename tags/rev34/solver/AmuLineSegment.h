...
private:
     ...
     * @param pt1 終点
     */
    void setVectorFromPoints(const AmuPoint pt0, const AmuPoint pt1);
     ...
     */
    void setVector(const AmuVector& mvec);
...
public:
     ...
     * @return 交点が存在するか
     */
    bool checkIntersectionkZ0(const AmuLineSegment& crSline,
                              AmuPoint *crossPoint = NULL);
};
