...
//======================================================================
bool OD::setValue(const string& start, const string& goal)
{
...
//======================================================================
void OD::setLastPassedStopPoint(const string passedInter)
{
    ...
    for(i = _lastPassedStopPoint + 1; i < _stopPoints.size(); i++)
    {
...
//======================================================================
const string& OD::start() const
{
    return _start;
}

//======================================================================
const string& OD::goal() const
{
    return _goal;
}
