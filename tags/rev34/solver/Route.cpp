...
//======================================================================
void Route::push(vector<Intersection*>& isec_vec)
{
    if(isec_vec.size() == 0)
    {
        return;
...
void Route::setLastPassedIntersection(Intersection* passed)
{
    ...
    for(int i = _lastPassedIntersection + 1; i < _route.size(); i++)
    {
        if(_route[i] == passed)
        {
...
//======================================================================
void Route::setLastPassedIntersection
(Intersection* prev, Intersection* passed)
{
...
Intersection* Route::next(Intersection* isec) const
{
    ...
    else if(_lastPassedIntersection < _route.size())
    {
