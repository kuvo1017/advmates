...
VehicleIO::VehicleIO()
{
    ...
    gvm.getVariable("RESULT_VEHICLE_STATIC_FILE", &resultFile);
    gvm.getVariable("RESULT_VEHICLE_DISTANCE_FILE", &distanceFile);
    _extension = (int)gvm.getNumeric("OUTPUT_VEHICLE_EXTENSION");
					 ...
					 vector<Vehicle*>* vehicles)
{
    ...
    gvm.getVariable("RESULT_GLOBAL_DYNAMIC_FILE", &fGlobalDynamic);
