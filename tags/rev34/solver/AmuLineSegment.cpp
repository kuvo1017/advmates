...
{
    setVectorFromPoints(point_begin, point_end);
...
//======================================================================
void  AmuLineSegment::setVectorFromPoints(const AmuPoint pt0,
                                          const AmuPoint pt1)
{
...
//======================================================================
void AmuLineSegment::setVector(const AmuVector& cr_mvec)
{
...
//======================================================================
bool AmuLineSegment::checkIntersectionkZ0(const AmuLineSegment& crSline,
                                          AmuPoint *crossPoint)
{
