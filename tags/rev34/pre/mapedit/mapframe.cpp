...
//ドラッグ中にホイールは入らなそう
//ダブルクリック前に開放＝クリックが入るので、そこで何もしてない状態でないと駄目、選択のみとか
//編集画面が上がるとフォーカスが外れるのでダブルクリックは入らない
//固定サイズで拡大／縮小できないので、画面リサイズ時に乱れるが、現状左上固定でなければ気にならない
//画面リサイズ時中心を合わせた方がいいかもしれないが、計算が複雑、現状あまり気にならない
//キー入力は現状ショートカットだけ可能
//ドラッグ中にQtデバッガで止めるとマシンストール、ドロップなら大丈夫
